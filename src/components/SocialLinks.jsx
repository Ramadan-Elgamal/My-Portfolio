...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/ramadan-elgamal-5190541a4",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@botsher_21",
    icon: Instagram,
    url: "https://www.instagram.com/botsher_21/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@ramadnan_botsher",
    icon: Youtube,
    url: "https://www.youtube.com/@ramadanbotsher7127",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Ramadan-Elgamal",
    icon: Github,
    url: "https://github.com/Ramadan-Elgamal",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@rb3.official",
    color: "black",
